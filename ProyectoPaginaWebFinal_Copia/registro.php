        ...
        <form method="post" autocomplete="off">
            ...
            <div class="input-group">
                ...
                <div class="input-container">
                    <input type="text" name="id_cliente" id="id_cliente" placeholder="Coloque su numero de id">
                    <i class="fa-solid fa-user"></i>
                </div>

                
                <div class="input-container">
                    <select class="id_evento" name="id_evento" id="id_evento">
                        ...
                        <?php
                            ...
                            $resultado=mysqli_query($conex, $eventos);
                            while($valores = mysqli_fetch_array($resultado)){
                                echo '<option value="'.$valores['id_evento'].'">'.$valores['id_evento'].'.-'.$valores['nombre'].'</option>';
                            }
                        ?>
                    </select>
